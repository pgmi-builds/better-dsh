...
/**
 * Vendored from `dsh-llm-fallbacks@0.3.5` (commit `95d9441`) and adapted for
 * in-dashr mounting: the plugin-entry metadata (`name` / `provide`) and the
 * package-manifest version read are gone — dashr owns those, and passes its
 * own version into {@link installFallbacks}.
 */
...
export function installFallbacks(ctx: Context, config: FallbacksConfig = defaultFallbacksConfig, version = '0.0.0'): void {
